class Member::GamesController < Member::MemberController
  ...
  def create
    ...
    respond_to do |format|
      if @game.save
        format.html { redirect_to(member_games_path, :notice => 'Game was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @game.update_attributes(params[:game])
        format.html { redirect_to(member_games_path, :notice => 'Successfully updated ' + @game.title) }
        format.xml  { head :ok }
      else
